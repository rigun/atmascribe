            ...
            $.each(catatans.catatan, function(key, cttn){
                if(cttn.prioritas == 1){
                    penting += "<tr>"+
                                    ...
                                    "<td><a  data-toggle='modal' data-target='#EditCatatan' onclick='editModalCatatan('"+
                                    cttn.id+
                                    "')'><img src='../img/icon/edit.svg' /></a>"+
                                    "<a  data-toggle='modal' data-target='#doneCatatan' onclick='doneCatatan('"+
                                    cttn.id+
                                    "')' ><img src='../img/icon/cekMini.svg' /></a></td>"+
                                "</tr>"
