...
<img src="<?php echo BASE_URL.'/img/icon/Logo.png'; ?>" alt="logo">
    ...
    <form id="myForm"  name="myForm" method="post" action="" onsubmit="return registration(event,'<?php echo date('Y-m-d H:i:s');?>','<?php echo bin2hex(random_bytes(5))?>')">
            ...
            <div class="wrap-input100" >
                    <input class="input100" type="email" id="email" name="email" placeholder="Email" value="" onchange="detectEmail(event)">
                ...
                <div class="wrap-input100" >
                    <input class="input100" type="password" id="konfirmasi" name="konfirmasiKataSandi" placeholder="Konfirmasi Kata Sandi" value="">
                    <span class="focus-input100" data-placeholder="&#xe80f;"></span>
            </div>
